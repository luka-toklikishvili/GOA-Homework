const buttons = [...document.querySelectorAll('.dashboard__option-btn')]; 
let data = [];
...
const clearActivities = () => {
    ...
    const activities = document.querySelectorAll('.dashboard__activity');
...
const renderCards = async (clickedOption) => {
    ...
    data.forEach(activity => {
        ...
        section.classList.add('dashboard__activity', activityClass);
